...
import numpy as np
from active_subspaces.utils.misc import process_inputs, process_inputs_outputs
from active_subspaces.utils.response_surfaces import PolynomialApproximation
from active_subspaces.gradients import local_linear_gradients
...
class Subspaces():
    ...
    def partition(self, n):
        ...
        if not issubclass(type(n), np.integer) and not isinstance(n,int):
